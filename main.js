...
imgOne.addEventListener('click', () => {
    ...
    const closeBtn = imgOnePopup.children[0];
...
imgTwo.addEventListener('click', () => {
    ...
    const closeBtn = imgTwoPopup.children[0];
    closeBtn.addEventListener('click', () => {
        imgTwoPopup.style["display"] = "none";
    })
})
...
imgThree.addEventListener('click', () => {
    ...
    const closeBtn = imgThreePopup.children[0];
    closeBtn.addEventListener('click', () => {
        imgThreePopup.style["display"] = "none";
    })
})
...
imgFour.addEventListener('click', () => {
    ...
    const closeBtn = imgFourPopup.children[0];
    closeBtn.addEventListener('click', () => {
        imgFourPopup.style["display"] = "none";
    })
})
...
imgFive.addEventListener('click', () => {
    ...
    const closeBtn = imgFivePopup.children[0];
    closeBtn.addEventListener('click', () => {
        imgFivePopup.style["display"] = "none";
    })
})
...
imgSix.addEventListener('click', () => {
    ...
    const closeBtn = imgSixPopup.children[0];
    closeBtn.addEventListener('click', () => {
        imgSixPopup.style["display"] = "none";
    })
})
...
imgSeven.addEventListener('click', () => {
    ...
    const closeBtn = imgSevenPopup.children[0];
    closeBtn.addEventListener('click', () => {
        imgSevenPopup.style["display"] = "none";
    })
})
...
imgEight.addEventListener('click', () => {
    ...
    const closeBtn = imgEightPopup.children[0];
    closeBtn.addEventListener('click', () => {
        imgEightPopup.style["display"] = "none";
    })
})